...
public class EditProfileActivity extends AppCompatActivity {
    ...
    String pass, name, phoneNo,typeLogin;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (method.getUserType().equals("normal")){
            typeLogin="normal";
        }else if(method.getUserType().equals("facebook")){
            typeLogin="facebook";
            viewEditProfile.cvPass.setVisibility(View.GONE);
        }else if(method.getUserType().equals("google")){
            typeLogin="google";
            viewEditProfile.cvPass.setVisibility(View.GONE);
        }
                ...
                try {
                    ...
                    if (editProfileRP != null) {
                        if (editProfileRP.getSuccess().equals("1")) {
                            method.saveLogin(method.getUserId(), name, viewEditProfile.etEmail.getText().toString(), typeLogin, "", editProfileRP.getItemUserEdits().getUser_image(), phoneNo);
