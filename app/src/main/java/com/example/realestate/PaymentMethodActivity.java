...
public class PaymentMethodActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPaymentBinding.llPlan.tvNoApplied.setText(getString(R.string.plan_apply,planLimit));
         ...
         cardViews = new CardView[]{viewPaymentBinding.cvPaypal, viewPaymentBinding.cvStripe, viewPaymentBinding.cvRazorPay, viewPaymentBinding.cvPayStack, viewPaymentBinding.cvPayUMoney,viewPaymentBinding.cvFlutterwave};
        textViews = new TextView[]{viewPaymentBinding.tvPaypal, viewPaymentBinding.tvStripe, viewPaymentBinding.tvRazorPay, viewPaymentBinding.tvPayStack, viewPaymentBinding.tvPayUMoney,viewPaymentBinding.tvFlutterwave};
        views = new View[]{viewPaymentBinding.rdPaypal, viewPaymentBinding.rdStripe, viewPaymentBinding.rdRazorPay, viewPaymentBinding.rdPayStack, viewPaymentBinding.rdPayUMoney,viewPaymentBinding.rdFlutterwave};
        ...
        viewPaymentBinding.cvFlutterwave.setOnClickListener(new View.OnClickListener() {
            @Override
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                switch (gatewayId) {
                                    ...
                                    case "6":
                                        ...
                                        break;
                                    case "8":
                                        viewPaymentBinding.tvFlutterwave.setText(gatewayName);
                                        ...
                                        Glide.with(getApplicationContext()).load(gatewayLogo)
                                                .placeholder(R.drawable.property_placeholder)
                                                .into(viewPaymentBinding.ivFlutterwave);
                                        break;
    ...
    private void displayData() {
        ...
        viewPaymentBinding.cvFlutterwave.setVisibility(paymentSetting.isFlutterWave() ? View.VISIBLE : View.GONE);
    }
    ...
    private void goFlutterWave() {
        Intent intentFlutter = new Intent(PaymentMethodActivity.this, FlutterWaveActivity.class);
        intentFlutter.putExtra("planId", planId);
        intentFlutter.putExtra("planName", planName);
        intentFlutter.putExtra("planPrice", planPrice);
        intentFlutter.putExtra("planCurrency", paymentSetting.getCurrencyCode());
        intentFlutter.putExtra("planGateway", "Flutterwave");
        intentFlutter.putExtra("planFlutterPublicKey", paymentSetting.getFlutterWavePublicKey());
        intentFlutter.putExtra("planFlutterEnrcyptKey", paymentSetting.getFlutterWaveEncryptionKey());
